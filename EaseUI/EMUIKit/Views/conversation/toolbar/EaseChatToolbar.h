...
typedef enum : NSUInteger {
    SYShowKeyboardType_None,
    SYShowKeyboardType_System,
    SYShowKeyboardType_Custom,
} SYShowKeyboardType;

@protocol EMChatToolbarDelegate;
@interface EaseChatToolbar : UIView

@property (nonatomic, assign) SYShowKeyboardType keyboardType;      // "键盘类型"

@property (nonatomic, assign) BOOL usedByPrivateMessage;            // ”私信“
